...
In [three](/posts/programming-horizons/) [previous](/posts/exploring-scheme-implementations/) [posts](/posts/programming-horizons-revisited/), I wrote about different programming languages that I have considered learning. I mentioned about 15 different languages in those posts. [F#](https://fsharp.org/) was not on the list. Because my background is in R, I thought I was better off sticking to learning dynamically typed languages at this point. Moreover, I hold a longstanding bias against Microsoft and Windows and that bias was easy to transfer to F#. 
...
I had [previously written](/posts/stochastic-population-model-r-racket/) about implementing a stochastic population model in Racket based on an R example found in [this blog post](https://www.seascapemodels.org/rstats/2017/02/26/speeding-up-sims.html). As a first exercise in F#, I've translated the stochastic population model into a few F# versions.
