---
title: Selecting, dropping, and renaming dataframe columns in Chez Scheme
author: Travis Hinkelman
date: '2020-03-29'
slug: selecting-dropping-renaming-dataframe-columns-chez-scheme
categories:
  - dataframe
  - ChezScheme
tags:
...
This post is the second in a [series](/categories/dataframe/) on the [dataframe library](https://hinkelman.github.io/dataframe/) for Chez Scheme. In this post, I will contrast the `dataframe` library with functions from base R and the [`dplyr` package](https://dplyr.tidyverse.org) for selecting, dropping, and renaming columns.
...
```
> (dataframe-select df 'c 'a)
#[#{dataframe fkhb7ma1yxo7aszand7h2a9p4-3}
  ((c 7 8 9) (a 1 2 3)) (c a) (3 . 2)]
```
...
#[#{dataframe fkhb7ma1yxo7aszand7h2a9p4-3}
  ((a 1 2 3) (Bee 4 5 6) (Sea 7 8 9)) (a Bee Sea) (3 . 3)]
```

To rename all of the columns, then `dataframe-rename-all` allows for specifying all new names as a list rather than `(old-name new-name)` pairs. 

```
> (dataframe-rename-all df '(A B C))
#[#{dataframe fkhb7ma1yxo7aszand7h2a9p4-3}
  ((A 1 2 3) (B 4 5 6) (C 7 8 9)) (A B C) (3 . 3)]
```
