...
This post is the second in a [series](/categories/dataframe/) on the [dataframe library](https://hinkelman.github.io/dataframe/) for Chez Scheme. In this post, I will contrast the `dataframe` library with functions from the [`dplyr` package](https://dplyr.tidyverse.org) for selecting, dropping, and renaming columns.
...
```
> (dataframe-view (dataframe-select df 'c 'a))
((c 7 8 9) (a 1 2 3))
```
...
```
> (dataframe-view (dataframe-drop df 'b))
((a 1 2 3) (c 7 8 9))
```
