...
categories: ["chez-stats", "Raven", "Chez Scheme"]
tags:
  - libraries
  - packages
  - statistics
...
Raven's [installation instructions](https://guenchi.gitbooks.io/raven/content/installation.html) are straightforward. However, on macOS Catalina, I had to use `sudo` when making a copy of the Chez Scheme compiler, i.e., `sudo cp chez scheme`. If you are getting [permission errors](https://github.com/guenchi/Raven/issues/11) with `curl -L http://ravensc.com/install | scheme`, then try `curl -o install.sc http://ravensc.com/install && sudo scheme ./install.sc`.
